...
class TestExtractCorrelationIdFromHeaders:
    ...
    def test_extract_from_baggage(self):
        """Test extraction from baggage header."""
        headers = {"baggage": "correlation-id=baggage-correlation-456,other=value"}
        result = extract_correlation_id_from_headers(headers)
        assert result == "baggage-correlation-456"

    def test_traceparent_priority_over_custom(self):
    ...
    def test_custom_priority_over_baggage(self):
...
class TestInjectCorrelationIdIntoHeaders:
    ...
    def test_inject_with_correlation_id(self):
    ...
    def test_inject_with_trace_context(self):
    ...
    def test_inject_generates_id_when_none_provided(self):
    ...
    def test_inject_uses_context_correlation_id(self):
...
class TestCorrelationIdPropagator:
    ...
    def test_fields_contains_expected_headers(self):
    ...
    def test_extract_integration(self):
    ...
    def test_inject_integration(self):
...
class TestMqttHelpers:
    ...
    def test_extract_from_mqtt_user_properties(self):
    ...
    def test_extract_from_mqtt_direct_attribute(self):
    ...
    def test_extract_returns_none_for_missing_properties(self):
    ...
    def test_inject_into_mqtt_properties(self):
    ...
    def test_inject_returns_properties_unchanged_when_no_userproperty(self):
...
class TestTraceHelpers:
    ...
    def test_get_current_trace_context_returns_none_when_no_span(self, mock_get_span):
    ...
    @patch("venus_observability.correlation.trace.get_current_span")
    def test_get_current_trace_context_returns_none_when_not_recording(self, mock_get_span):
    ...
    @patch("venus_observability.correlation.trace.get_current_span")
    def test_get_current_trace_context_returns_context(self, mock_get_span):
    ...
    def test_create_span_with_correlation(self, mock_tracer_class):
    ...
    @patch("venus_observability.correlation.trace.Tracer")
    def test_traced_operation_alias(self, mock_tracer_class):
